...
from src.models.m_xiaohongshu import NoteUrlInfo, CreatorUrlInfo
from src.services.proxy.proxy_ip_pool import IpInfoModel, create_ip_pool
                ...
                try:
                    ...
                    for note_detail in note_details:
                        if isinstance(note_detail, Exception):
                            utils.logger.error(f"[XiaoHongShuCrawler.search] Failed to get note detail: {note_detail}")
                            continue
                        if note_detail:
